...
def analyze_for_buying(wallet_name, typed_companies_list, source_data):
    ...
    buy(source_data, typed_companies_list, wallet)
    save_wallet(wallet_name, wallet)


def buy(source_data, typed_companies_list, wallet):
    ...
    for single_company_index in range(starting_index, -1, -1):
        ...
        counts = int(STARTING_FUNDS / MAX_COMPANIES_IN_WALLET / close_price)
...
def sell(wallet_name, wallet, source_data):
    ...
    for single_company in wallet:
        ...
        if close_price > take_profit:
            ...
            wallet_after_selling.append([company_name, get_number_of_shares_for_company_in_wallet(single_company),
                                         purchase_price, get_purchase_date_for_company_in_wallet(single_company),
